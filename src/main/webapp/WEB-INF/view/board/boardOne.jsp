					...
					<div class="card">
						<div class="card-body px-lg-5">
							...
							<c:if test="${b.memberId eq loginMember.memberId}"> <!-- eq : jstl 문자열비교(같으면 true) -->
								<a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/board/modifyBoard?boardNo=${b.boardNo}">수정</a>
								<a class="btn btn-sm btn-outline-danger" id="deleteBoardBtn" href="${pageContext.request.contextPath}/board/removeBoard?boardNo=${b.boardNo}">삭제</a>
							</c:if>
						</div>
					</div>
				</div>
